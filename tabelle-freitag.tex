...
\section*{Donnerstag}\label{freitag}
	\begin{longtabu}{lZ{2.93cm}Z{2.93cm}Z{2.93cm}}
		...
		\endhead
		08:45
		\talk{Indoor Routing in Gebäuden des öffentlichen Verkehrs auf Basis von OpenStreetMap Daten}{Thomas Jakubicka}
		...
		\talk{Verkehrsmittelbezogene Erreichbarkeitsvisualisierung der Ruhr-Universität Bochum}{Marc Beiling}
		...
		\talk{Der schwere Werdegang zu einem FOSSGIS-Open Source Projekt}{Oliver Tonnhofer, Till Adams}
		\coffeespace\tabularnewline
		\rowcolor{commongray}
		...
		\coffeespace\tabularnewline
		11:30
		\talk{FlatMatch: Online-Wohnungssuche mit OSM-Daten}{Robert Buchholz}
		...
		12:00 & \multicolumn{3}{c}{%
			...
			Kaffeepause} \tabularnewline
		12:30
		\aulaevent{Abschlussveranstaltung}{Marco Lechner}
		\coffeespace\tabularnewline
		13:30
		\aulaevent{Sektempfang}{}
		\coffeespace\tabularnewline
	\end{longtabu}	
\end{landscape}
