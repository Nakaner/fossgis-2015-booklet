...
\abstractZwei{Simon Jirka}{Erfahrungen mit Sensor Web-Anwendungen für mobile Geräte und Desktop-Anwendungen}{}{%
	Dieser Vortrag stellt einen freien, auf JavaScript basierenden Sensor Web-Client vor, 
...
\abstractZehn{Johannes Weskamm}{Vector Tiles}{Performante Übertragung von umfangreichen Vektordaten}{%
	Der Vortrag beleuchtet die Vor- und Nachteile von Vectortiling und der Vektordaten-Prozessierung im Client allgemein. 
...
% 17:30
%
\abstractZwei{Till Adams}{SHOGun BoF/Anwender- und Entwicklertreffen}{}{Es wird der aktuelle Entwicklungsstand von SHOgun, neue Ideen und auch neue Entwicklungen, die seit der FOSSGIS 2014 dazu gekommen sind, vorgestellt.}
...
% 19:00
%
\abstractSenatssaal{Marco Lechner}{Vollversammlung FOSSGIS e.V.}{}{Die ordentlichen Mitgliederversammlung 2015 des FOSSGIS e.V.}