...
\abstractZwei{Stefan Ziegler}{Kreisbogen in QGIS}{}{Neben den gängigen Vektorelementen (Punkt, Linie, Polygon) 
	...
	(ST\_CircularString, ST\_CompoundCurve, ST\_CurvePolygon etc.) aus einer PostGIS-Datenbank zu lesen, 
...
\abstractZehn{Oliver Tonnhofer}{Mapnik oder MapServer}{Wer macht die schönsten Karten?}{%
	Mit Mapnik und MapServer stehen zwei Open-Source-Kartenrenderer zur Verfügung, die in Geschwindigkeit, 
...
\abstractEins{Peter Barth}{Crowd-Sourced Elevation}{DIY DEM}{%	
	...
	aber auch bei Routinganwendungen für Fahrradfahrer, Rollstuhlfahrer und Elektrofahrzeuge.
...
\abstractZehn{Daniel Koch}{GeoServer in action}{Fortgeschrittene Möglichkeiten beim Einsatz des GeoServers}{%
	Der GeoServer ist ein weithin bekannter und mächtiger Open-Source-Kartenserver. Sofern man die Umgebung 
...
\abstractEins{Hongchao Fan}{Die neue WebGL-basierte Plattform für OSM-3D}{}{%
	In diesem Vortrag wird die technische Archtektur, das Funktionsdesign und die 
