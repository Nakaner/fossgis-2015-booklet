...
\abstractZwei{Tobias Preuß}{Projekt Umweltzone}{Zwischen Open-Data und OpenStreetMap}{%
	...
	um eine kostenlose Open-Source-App für Android-Geräte, mit der sich Benutzer 
...
\abstractZehn{Sven Böhme}{Öffentliche Projekte und Open Source}{Open-Source-Software in der öffentlichen Verwaltung am Beispiel der GDI-DE Testsuite}{%
	...
	im Bundesamt für Kartographie und Geodäsie wurde als Schnittstelle zwischen der fachlichen und der 
...
\abstractZwei{Marc Beiling}{Verkehrsmittelbezogene Erreichbarkeitsvisualisierung\vspace{0.3em}}{%
	Eine beispielhafte Mappinganwendung im Mobilitätskontext der Ruhr-Universität Bochum}{%
	Der Vortrag behandelt die Anwendung Verkehrsmittelbezogener Erreichbarkeitsvisualisierung für 
	Studierende der Ruhr-Universität Bochum, die als beispielhafte Umsetzung zu verstehen ist. 
	Es werden die Herausforderungen beim Routing mit OSM-Daten werden aufgezeigt und Neulingen im 
...
\abstractZehn{Peter Löwe}{Das audiovisuelle Erbe der OSGeo-Projekte }{Referenzfall GRASS GIS -- und Star Trek}{%
	...
	stellt das AV-Portal der Technischen Informationsbibliothek vor. Das Portal ist eine zukunftssichere 
	Alternative oft praktizierten eher flüchtigen Datenaustausch über Plattformen wie Youtube oder 
	...
	Army Corps of Engineers Research Laboratory aus dem Jahr 1987 demonstriert.}
...
\abstractZwei{Friedrich Müller}{Linked Data basierter Explorer}{%
	...
	krebsrelevanter Informationen. Neben der Möglichkeit sich über die krebsbezogenen Ur\-sache-Wirkungs-Beziehungen zu informieren, 
	ist der eigentliche Nutzen der Applikation die ermöglichte Erforschung von Umweltdatenim Zusammenhang 
	mit epidemiologischen Datensätzen u.\,a. per Geovisualisierungen für die Beispielregion Westfalen-Lippe.
	
	Der Workflow basiert komplett auf freier Software und Daten, z.\,B. Protegé, Apache Jena, R, OSM und Leaflet. 
...
\abstractEins{Roland Olbricht}{Schatzsuche in OpenStreetMap}{}{%
	...
	Wo fehlen wahrscheinlich noch Briefkästen? Welche Brü\-cken haben keine Höhenangabe? 
	...
	Neben einer Präsentation der Ergebnisse werden dabei auch ausführlich die verwendeten Overpass-API-Abfra\-gen vorgestellt, 
	sodass jeder die Abfragen leicht für seine Stadt wiederholen oder inhaltlich anpassen kann.}
\abstractZwei{Daniel Kastl}{Location-based Task Management}{Standortbezogene Aufgabenverwaltung für mobile Arbeitsplätze}{%
	...
	Mit der Optimierung von Arbeitsabläufen und Tourenplanung im Hinterkopf und auf Grundlage verfügbarer 
	freier Software 
...
\abstractZehn{Felix Kunde}{3D-GIS-Stack aus Open-Source-Komponenten}{}{%
	In den letzten Jahren hat die dritte Dimension auch Einzug in den gängigen FOSSGIS-Lösungen (PostGIS, QGIS, OpenLayers etc.) 
	gehalten, sodass mittlerweile ein kompletter 3D-GIS-Stack aus Open-Source-Lösungen realisiert werden kann. 
...
\abstractEins{Robert Buchholz}{FlatMatch -- Online-Wohnungssuche mit OSM-Daten}{Können wir tausende deutsche Vermieter zu OSM-Mitwirkenden machen?}{%
	...
	Die Mitarbeit kommer\-zieller Nutzer an OSM hängt jedoch allein davon ab, ob sie dadurch einen 
	wirtschaftlichen Mehrwert erhalten. Zehntausenden kleinen und mittleren Unternehmen in Deutschland 
	könnte Flat\-Match diesen Mehrwert bieten.}
...
\abstractZwei{Tobias Sauerwein}{MapFish Print V3 -- Printing maps like a boss\vspace{0.3em}}{}{%
	...
	wobei eine Vielfalt von Quellen unterstützt wird, z.\,B. WMS, WMTS, OSM-Kacheln, WFS oder GeoJSON.
...
\abstractZehn{Elisabeth Leu}{Cesium -- der 3D-Globus im Web}{}{%
	...
	Cesium nutzt WebGL und unterstützt außerdem OGC-Standards wie WMS oder WMTS.
	...
	Wo wird überall Cesium eingesetzt? Außerdem wird die Kombination von OpenLayers\,3 mit Cesium vorgestellt 
	und ein Ausblick über die künftige Entwicklung gegeben.}
\input{sponsorentexte/401-oreilly}
%
% 12:30
\newtimeslot{12:30}
%
\abstractAula{Marco Lechner}{Abschlussveranstaltung}{}{%
Die Abschlussveranstaltung blickt auf die gelaufene Konferenz 
und auf die nächste. In diesem Rahmen findet auch die Verlosung 
statt, an der alle teilnehmen, die den Teilnehmerfeedbackbogen ausgefüllt haben.}
%
% 13:30
\newsmalltimeslot{13:30}
\vspace{-1em}
\abstractFoyer{Katja Haferkorn}{Sektempfang}{}{}
\vspace{-1.5em}
